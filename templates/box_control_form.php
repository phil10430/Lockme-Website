<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
 ...
 <div class="boxcontrol-elements">
    ...
    <!-- Mit Passwort -->
    <button type="button" onclick="openPasswordDialog()" class="btn btn-round w-100" id="close-box-pw-btn">CLOSE PW</button>
    <button type="submit" name="closeBoxWithPw" id="closeBoxWithPw" style="display:none;"></button>
    <!-- Mit Timer -->
    <button type="button" onclick="openTimerDialog()" class="btn btn-round w-100" id="close-box-timer">CLOSE TIMER</button>
    <button type="submit" name="closeBoxWithTimer" id="closeBoxWithTimer" style="display:none;"></button>
    <!-- Mit Passwort und Timer -->
    <button type="submit" name="closeBoxPwTimer" class="btn btn-round w-100" id="close-box-pwtimer">CLOSE PW+TIMER</button>
</div>
</form>