...
<div class="boxcontrol-elements">
    ...
    <div style="grid-column: 1 / -1; display:flex; justify-content:center;">
        ...
        <button type="submit" name="openBox" class="btn btn-round" id="openBox">
            <img src="/assets/images/icon_open.png" style="width:15px; object-fit:contain;">
        </button>
         <?php // OPEN with password: öffnet Dialog, wird im JS über id="open-box-pw-btn" referenziert ?>
        <button type="button" onclick="openOpenDialog()" class="btn btn-round" id="open-box-pw-btn" >
            <img src="/assets/images/icon_open.png" style="width:15px; object-fit:contain;">
        </button>
    ...
    <!-- EXTEND TIME Row -->
    <div style="grid-column: 1 / -1; display:flex; justify-content:center;">
        <button type="button" name= "extendTime" onclick="lockDialog('extendTime')" class="btn btn-round" id="extend-time-btn" >
                <img src="/assets/images/icon_extend_timer.png" style="width:20px;  object-fit:contain;">
        </button>
    ...
    <div style="grid-column: 1 / -1; display:flex; justify-content:center; gap:20px;">
        <button type="button" onclick="lockDialog('password')" class="btn btn-round" id="close-box-pw-btn">
            <img src="/assets/images/icon_password.png" style="width:30px;  object-fit:contain;">
        </button>
        <button type="submit" name="closeBoxWithPw" id="closeBoxWithPw" style="display:none;"></button>

        <button type="button" onclick="lockDialog('timer')" class="btn btn-round" id="close-box-timer"">
            <img src="/assets/images/icon_timer.png" style="width:20px; object-fit:contain;">
        </button>
    ...
    <div style="grid-column: 1 / -1; display:flex; justify-content:center;  gap:20px;">
        ...
        <button type="button" onclick="lockDialog('passwordTimer')" class="btn btn-round" id="close-box-pwtimer"">
            <img src="/assets/images/icon_password_timer.png" style="width:20px; object-fit:contain;">
        </button>
        <button type="submit" name="closeBoxWithPasswordTimer" id="closeBoxWithPasswordTimer" style="display:none;"></button>


         <button type="button" onclick="openRandomTimerDialog()" class="btn btn-round" id="close-box-randtimer"">
            <img src="/assets/images/icon_random_timer.png" style="width:20px; object-fit:contain;">
        </button>
